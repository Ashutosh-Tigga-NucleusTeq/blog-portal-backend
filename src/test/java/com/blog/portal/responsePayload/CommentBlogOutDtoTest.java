...
public class CommentBlogOutDtoTest {

    private CommentsOutDto comment1;
    private CommentsOutDto comment2;
    private CommentsOutDto comment3;

    @BeforeEach
    public void setUp() {
        comment1 = new CommentsOutDto("1", "Great post!", "user1", "post1");
        comment2 = new CommentsOutDto("2", "Nice article.", "user2", "post1");
        comment3 = new CommentsOutDto("1", "Great post!", "user1", "post1");
    }
    ...
    public void testConstructors() {
        ...
        CommentsOutDto defaultComment = new CommentsOutDto();
    ...
    public void testToString() {
        String expectedToString = "CommentsOutDto [id=1, content=Great post!, userId=user1, postId=post1]";
