...
public class ReportedBlogsOutDtoTest {

    private ReportedBlogsOutDto reportedPost1;
    private ReportedBlogsOutDto reportedPost2;
    private ReportedBlogsOutDto reportedPost3;

    @BeforeEach
    public void setUp() {
        List<String> reportReason1 = new ArrayList<>();
        reportReason1.add("Spam");
        reportedPost1 = new ReportedBlogsOutDto("1", "user1", "post1", reportReason1);

        List<String> reportReason2 = new ArrayList<>();
        reportReason2.add("Inappropriate");
        reportedPost2 = new ReportedBlogsOutDto("2", "user2", "post2", reportReason2);

        List<String> reportReason3 = new ArrayList<>();
        reportReason3.add("Spam");
        reportedPost3 = new ReportedBlogsOutDto("1", "user1", "post1", reportReason3);
    }
    ...
    public void testConstructors() {
        ...
        ReportedBlogsOutDto defaultReportedPost = new ReportedBlogsOutDto();
    ...
    public void testToString() {
        String expectedToString = "ReportBlogInDto [id=1, +userId=user1, postId=post1, reportReason=[Spam]]";
