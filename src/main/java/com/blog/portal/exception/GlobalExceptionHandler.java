...
/**
 * This class is responsible for handling exceptions globally and returning appropriate API responses.
...
public class GlobalExceptionHandler {
     ...
     * @param ex The exception of type UserAlreadyExistsException.
     * @return A ResponseEntity containing an ResponseOutDTO
     * with an error message and status code.
     */
    @ExceptionHandler(UserAlreadyExistsException.class)
    public ResponseEntity<ResponseOutDTO> handleRegistrationException(
    ...
    public ResponseEntity<ResponseOutDTO> handleUnauthorizedUserException(
