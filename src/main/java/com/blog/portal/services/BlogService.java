...
/**
 * Interface PostService that represent the rule of Blog that would follow by it's child.
...
public interface BlogService {
	 ...
	 */
	ResponseOutDTO createPost(PostBlogInDto postBlogInDto);
	 ...
	 * @return ResponseOutDTO
	 */
	ResponseOutDTO editBlog(UpdateBlogInDto inDto);
	...
	/**
	 * Admin can approve or reject unreviewed code using inDto that contains post id and post status.
	 * @param inDto
	 * @return response
	 */
	ResponseOutDTO actOnUnreviewedBlog(ActOnUnReviewedBlogInDto inDto);
